function changeNewsDetail1() {
	$(".canhcam-news-details-1 .news-read ,.canhcam-news-details-2 .news-read").lightGallery({
		thumbnail: true,
		animateThumb: false,
...
function changeIMGtoDiv1(){
	$('.canhcam-news-details-1 .othernews .item figure , .canhcam-news-details-2 .othernews .item figure').each(function () {
